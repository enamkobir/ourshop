				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.html"><img src="{{URL::to('frontand/images/home/logo.png')}}" alt="" /></a>
						</div>
		...
		<div class="container">
            ...
            <div class="carousel-inner">
              <div class="item active">
               ...
               <div class="col-sm-8">
                <img src="{{asset('public/frontand/images/home/megastore_slider5.jpg')}}" class="girl img-responsive" alt="" />
                <img src="{{asset('public/frontand/images/home/megastore_slider5.jpg')}}"  class="pricing" alt="" />
               </div>
              </div>
                   <?php
                   ...
                   <div class="item">
                    <div class="col-sm-4">
                     <h1><span>OUR</span>-SHOP</h1>
                     <h2>Latest Design Collection</h2>
                     <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
                     <button type="button" class="btn btn-default get">Get it now</button>
                    </div>
                    <div class="col-sm-8">
                     <img src="{{url($item->slider_image)}}" class="girl img-responsive" alt="" />
                     <img src="{{asset('frontand/images/home/pricing.png')}}"  class="pricing" alt="" />
                    </div>
                   </div>
                       <?php } ?>
                  </div>
		...
		<div class="container">
          ...
          <?php }?>
                  ...
                  foreach($all_published_manufacture as $v_manufacture){?>
									<li><a href="{{URL::to('/product_by_manufacture/'.$v_manufacture->manufacture_id)}}"> <span class="pull-right">(50)</span>{{$v_manufacture->manufacture_name}}</a></l>
                  <?php }?>
								</ul>
							</div>
						</div><!--/brands_products-->
