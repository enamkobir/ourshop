...
class HomeController extends Controller
{
  public function index(){
    $all_published_product=DB::table('tbl_products')->orderby('product_id','asc')
    ...
    return view('layout')
            ->with('admin.all_product',$manage_published_product);
  }
  public function show_product_by_category($category_id){
    $product_by_category=DB::table('tbl_products')->orderby('product_id','asc')
                     ->join('tbl_category','tbl_products.category_id','tbl_category.category_id')
  ...
  public function show_product_by_manufacture($manufacture_id){
    $product_by_manufacture=DB::table('tbl_products')->orderby('product_id','asc')
                     ->join('tbl_category','tbl_products.category_id','tbl_category.category_id')
                     ->join('tbl_manufacture','tbl_products.manufacture_id','tbl_manufacture.manufacture_id')
                     ->select('tbl_products.*','tbl_category.category_name','tbl_manufacture.manufacture_name')
  ...
  public function product_details_by_id($product_id){
    $product_by_details=DB::table('tbl_products')->orderby('product_id','asc')
                     ->join('tbl_category','tbl_products.category_id','tbl_category.category_id')
                     ->join('tbl_manufacture','tbl_products.manufacture_id','tbl_manufacture.manufacture_id')
                     ->select('tbl_products.*','tbl_category.category_name','tbl_manufacture.manufacture_name')
    ...
    return view('layout')
            ->with('pages.manufacture_by_products',$manage_product_by_details);
  }
}
